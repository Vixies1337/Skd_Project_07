...
export const calendarEvents = [
  {
    title: "Blockchain",
    allDay: false,
    start: new Date(2024, 9, 21, 8, 54),
    end: new Date(2024, 9, 21, 9, 39),
  },
  {
    title: "Mạng máy tính",
    allDay: false,
    start: new Date(2024, 9, 21, 10, 37),
    end: new Date(2024, 9, 21, 11, 22),
  },
  {
    title: "Blockchain",
    allDay: false,
    start: new Date(2024, 9, 21, 12, 12),
    end: new Date(2024, 9, 21, 12, 57),
  },
  {
    title: "Phân tích dữ liệu lớn",
    allDay: false,
    start: new Date(2024, 9, 21, 13, 52),
    end: new Date(2024, 9, 21, 14, 37),
  },
  {
    title: "Xử lý ảnh kỹ thuật số",
    allDay: false,
    start: new Date(2024, 9, 21, 15, 25),
    end: new Date(2024, 9, 21, 16, 10),
  },
  {
    title: "Lập trình C++",
    allDay: false,
  ...
  },
  {
    title: "Lập trình C++",
    allDay: false,
    start: new Date(2024, 9, 22, 9, 41),
    end: new Date(2024, 9, 22, 10, 26),
  },
  {
    title: "An ninh mạng",
    allDay: false,
    start: new Date(2024, 9, 22, 11, 16),
    end: new Date(2024, 9, 22, 12, 1),
  },
  {
    title: "An ninh mạng",
    allDay: false,
    start: new Date(2024, 9, 22, 12, 53),
    end: new Date(2024, 9, 22, 13, 38),
  },
  {
    title: "Điện toán đám mây",
    allDay: false,
    start: new Date(2024, 9, 22, 14, 37),
    end: new Date(2024, 9, 22, 15, 22),
  },
  {
    title: "Lập trình C++",
    allDay: false,
  ...
  },
  {
    title: "Lập trình C++",
    allDay: false,
    start: new Date(2024, 9, 23, 9, 40),
    end: new Date(2024, 9, 23, 10, 25),
  },
  {
    title: "Học máy",
    allDay: false,
    start: new Date(2024, 9, 23, 11, 25),
    end: new Date(2024, 9, 23, 12, 10),
  },
  {
    title: "Hệ thống nhúng",
    allDay: false,
    start: new Date(2024, 9, 23, 13, 9),
    end: new Date(2024, 9, 23, 13, 54),
  },
  {
    title: "Khoa học dữ liệu",
    allDay: false,
    start: new Date(2024, 9, 23, 14, 50),
    end: new Date(2024, 9, 23, 15, 35),
  },
  {
  ...
  },
  {
    title: "Hệ thống nhúng",
    allDay: false,
    start: new Date(2024, 9, 24, 9, 35),
    end: new Date(2024, 9, 24, 10, 20),
  },
  {
    title: "Điện toán đám mây",
    allDay: false,
    start: new Date(2024, 9, 24, 11, 20),
    end: new Date(2024, 9, 24, 12, 5),
  },
  {
    title: "Phát triển Web",
    allDay: false,
    start: new Date(2024, 9, 24, 12, 52),
    end: new Date(2024, 9, 24, 13, 37),
  },
  {
    title: "Học máy",
    allDay: false,
    start: new Date(2024, 9, 24, 14, 37),
    end: new Date(2024, 9, 24, 15, 22),
  },
];
