...
const columns = [
    ...
    { header: "Mã sinh viên", accessor: "studentId", className: "hidden md:table-cell" },
    ...
    <tr key={item.id} className='border-b border-gray-200 even:bg-slate-50 text-sm hover:bg-PYellowLight'>
        ...
        <td>
            <div className="flex items-center gap-2">
                <Link href={`/list/students/${item.id}`} legacyBehavior>
    ...
    return (
        <div className="bg-white p-4 rounded-md flex-1 m-4 mt-0">
            ...
            <div className="flex items-center justify-between">
                <h1 className="hidden md:block text-lg font-semibold">Sinh Viên</h1>
